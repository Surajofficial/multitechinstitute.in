...
@media only screen and (max-width: 800px) {
 ...
 <div id="mySidenav" class="sidenav d-block d-md-none">
  ...
  <div class="dropdown-container">
    <!-- <a href="#">Link 1</a> -->
            <a class="dropdown-item" href="../laptop-repairing-course.php">Laptop Repairing Course</a>
            <a class="dropdown-item" href="../mobile-repairing-course.php">Mobile Repairing Course</a>
            <a class="dropdown-item" href="../led-tv-repairing-course.php">LED TV Repairing Course</a>
            <a class="dropdown-item" href="../printer-repairing-course.php">Printer Repairing Course</a>
            <a class="dropdown-item" href="../cctv-training-institute.php">CCTV Repairing Course</a>
            <a class="dropdown-item" href="../e-vehicle-repairing-course.php">E-Vehicle Repairing Course</a>
            <a class="dropdown-item" href="../ac-repairing-course.php">AC PCB Repairing Course</a>
            <a class="dropdown-item" href="../fridge-and-washing-machine.php">Fridge And Washing Machine Repairing Course</a>
            <a class="dropdown-item" href="../inverter-repairing-course.php">Inverter Repairing Course</a>
  </div>
  ...
  <div class="dropdown-container">
            <a class="dropdown-item" href="../online-laptop-repairing-course.php">Online Laptop Repairing Course</a>
            <a class="dropdown-item" href="../online-mobile-repairing-course.php">Online Mobile Repairing Course</a>
            <a class="dropdown-item" href="../online-led-tv-repairing-course.php">Online LED TV Repairing Course</a>
            <a class="dropdown-item" href="../online-printer-repairing-course.php">Online Printer Repairing Course</a>
            <a class="dropdown-item" href="../online-cctv-training-institute.php">Online CCTV Repairing Course</a>
            <a class="dropdown-item" href="../online-e-vehicle-repairing-course.php">Online E-Vehicle Repairing Course</a>
  </div>

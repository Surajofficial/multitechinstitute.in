<?php 
 ...
 function mks_sendMail($args){
    ...
    try {
        ...
        $mail->Host       = 'multitechinstitute.com';                    // Set the SMTP server to send through
...
<table style="text-align:center;width: 30%;margin-left:auto;
    margin-right:auto;">
    <tr>
        <td><img src="https://www.multitechinstitute.com/images/logo.png" style="max-width:100px;"></td>
    </tr>
</table>
...
/*
 $args = array(
 "to"=>'dev.acnosoft@gmail.com',
 "subject"=>"My first Testing Mail form Gee7",
 "msg"=>"this is message which will convert to html message soon",
 "cc"=>'mksharmaphp@gmail.com',
 "bcc"=>'kumar.kapil0905@gmail.com'),
 ;
 mks_sendMail($args );
*************************************************************/

   ...
   <div class="container-fluid marquee_area">
    ...
    if($name==''){
        ...
        <script>
            ...
            window.location.href = "https://www.multitechinstitute.com/mobile-repairing-course/";

        </script>

        <?php

        header("location: https://www.multitechinstitute.com/mobile-repairing-course/");
    ...
    $args = array("to"=>'multitechinstitute25@gmail.com',"bcc"=>'dev.acnosoft@gmail.com',"subject"=>"$uname, Booked Demo Class on your website.","msg"=>$mailMsg);
        ...
        <div class="container">
            ...
            <div class="row" style="text-align:center">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <a href="https://www.multitechinstitute.com/mobile-repairing-course/" class="btn btn-success">Go to home</a>
    ...
    <?php }  } else { header("Location: https://www.multitechinstitute.com/mobile-repairing-course/");} ?>

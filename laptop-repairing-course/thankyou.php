...
<head>
    ...
    <meta name="description" content="Multitech is the best laptop repairing institute in India">

    <meta name="keywords" content="laptop repairing course, laptop repairing institute">

    <!-- Favicons -->

    <link rel="shortcut icon" href="https://www.multitechinstitute.in/images/logof.png">
...
<body data-spy="scroll" data-target="#navbar" data-offset="100">
   ...
   <div class="container-fluid marquee_area">
    ...
    if($name==''){
        ...
        <script>
            ...
            window.location.href = "http://www.multitechinstitute.in/laptop-repairing-course/";

        </script>

        <?php

        header("location: http://www.multitechinstitute.in/laptop-repairing-course/");
   ...
   /* $email = htmlspecialchars(trim($_POST['email']));
    ...
    $args = array("to"=>'multitechtilaknagar@gmail.com',"subject"=>"$uname, Booked Demo Class - Laptop Repairing Course - on your website.","msg"=>$mailMsg);
        ...
        <div class="container">
            ...
            <div class="row" style="text-align:center">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <a href="http://www.multitechinstitute.in/laptop-repairing-course/" class="btn btn-success">Go to home</a>
    ...
    <?php }  } else { header("Location: http://www.multitechinstitute.in/laptop-repairing-course/");} ?>

...
<body data-spy="scroll" data-target="#navbar" data-offset="100">
   ...
   <div class="container-fluid marquee_area">
    ...
    if($name==''){
        ...
        <script>
            window.location.href = "https://www.multitechinstitute.in/ledtv-repairing-course/";
        </script>
        <?php
        header("location: https://www.multitechinstitute.in/ledtv-repairing-course/");
    }
    ...
    if($email ==''){
        ...
        <script>
            ...
            window.location.href = "http://www.multitechinstitute.in/ledtv-repairing-course/";

        </script>

        <?php

        header("location: http://www.multitechinstitute.in/ledtv-repairing-course/");
    ...
    $args = array("to"=>'multitechtilaknagar@gmail.com',"subject"=>"$uname, Booked Demo Class- Led TV  Repairing Course- on your website.","msg"=>$mailMsg);
        ...
        <div class="container">
            ...
            <div class="row" style="text-align:center">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <a href="http://www.multitechinstitute.in/ledtv-repairing-course/" class="btn btn-success">Go to home</a>
    ...
    <?php }  } else { header("Location: http://www.multitechinstitute.com/ledtv-repairing-course/");} ?>
